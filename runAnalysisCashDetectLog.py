...
#! /usr/bin/env python
#------------------------------------------------------------
# filename: runAnalysisCashDetectLog.py
...
CSVfile_DIR = getcwd() + '/csvfiles/dailyDataFrame/detect/cash/'
FIGfile_DIR = getcwd() + '/fig/detectlogData/cash/' + analysisdate + '/'
OCCSV_DIR  = getcwd() + '/csvfiles/occupancyRate/cash/'
NumofDeviceType =130
...
if not os.path.exists(OCCSV_DIR):
    subprocess.check_call('mkdir ' + OCCSV_DIR, shell= True)


intro.intro_CashDetectLogAnalysis()
...
for i in range(0, len(logdatelist)):
    ...
    csvfilename = CSVfile_DIR + logdate + '_detectLog_cash_DailyDataFrame.csv'
...
for k in range(0,len(sdkTypeList)):
    ...
    if not (dfInValidBeacon_curr.empty):
        ...
        if isPerDevAnalysis:
            ...
            entireDevOccupancyRatePercenCSV.to_csv(OCCSV_DIR + str(datetime.datetime.today().date()) + '_OccupancyRateCash.csv')
            ...
            if isPerDevPlot:
                ...
                beaconErrRateForPlot = beaconErrRatePercent[beaconErrRatePercent > 1.0]  # plot phoneModel above 1%
                ...
                hfig1.savefig(currFIGfile_DIR + analysisdate + '_cash_phoneModelOccupancyRate.png')
                ...
                if not(beaconErrRateForPlot.empty):
                    ...
                    pyplot.xlabel('phoneModel')
                    hfig2.savefig(currFIGfile_DIR + analysisdate + '_cash_beaconErrRate.png')
                ...
                if not(weightedBERPercent.empty):
                    ...
                    hfig3.savefig(currFIGfile_DIR + analysisdate + '_cash_weightedBER.png')
            ...
            if isEdSNRPlot:
                ...
                for j in range(0,len(weightedBERPercent.index)):
                    ...
                    pyplot.title(currDev)
                    pyplot.legend(['Valid','Invalid'])
                hfig4.savefig(currFIGfile_DIR + analysisdate + '_cash_edSNRdBvsfreqLineMSEdB.png')
                hfig5.savefig(currFIGfile_DIR + analysisdate + '_cash_edSNRdBvsfreqLineSlope.png')
                hfig6.savefig(currFIGfile_DIR + analysisdate + '_cash_edSNRdBcvsedTy.png')
                ...
                for j in range(0,len(weightedBERPercent.index)):
                    ...
                    pyplot.title(currDev)
                    pyplot.legend(['Valid','Invalid'])
                hfig15.savefig(currFIGfile_DIR + analysisdate + '_cash_edNoisedBcvsedTy.png')
            ...
            if isFreqLineDetPlot:
                ...
                for j in range(0,len(weightedBERPercent.index)):
                    ...
                    pyplot.title(currDev)
                    pyplot.legend(['Valid','Invalid'])
                hfig11.savefig(currFIGfile_DIR + analysisdate + '_cash_freqLineMSEdBvsfreqLineSlope.png')
            ...
            if isPdfFitting:
                ...
                hfig12.savefig(currFIGfile_DIR + analysisdate + '_cash_edSNR_Valid_Hist.png')
                ...
                for j in range(0, len(checkPhoneList)):
                    ...
                    pyplot.xlabel('edSNRdB')
                    pyplot.legend(loc='upper right')
                hfig17.savefig(currFIGfile_DIR + analysisdate + '_cash_edSNR_Invalid_Hist.png')
            ...
            if isEdTyPlot:
                ...
                for j in range(0,len(weightedBERPercent.index)):
                    ...
                    pyplot.title(currDev)
                    pyplot.legend(['Valid','Invalid'])
                hfig7.savefig(currFIGfile_DIR + analysisdate + '_cash_edTyvsfreqLineMSEdB.png')
                hfig8.savefig(currFIGfile_DIR + analysisdate + '_cash_edTyvsfreqLineSlope.png')
        ...
        if isTimeLineAnalysis:
            ...
            hfig10.savefig(currFIGfile_DIR + analysisdate + '_cash_timeLineAnalysis.png')
